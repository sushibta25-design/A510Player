...
A510Player_FILES = main.m AppDelegate.m PlayerViewController.m CarPlaySceneDelegate.m
A510Player_CFLAGS = -fobjc-arc
A510Player_FRAMEWORKS = UIKit Foundation AVFoundation VideoToolbox CoreMedia CoreVideo QuartzCore CarPlay
